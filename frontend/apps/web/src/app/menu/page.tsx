  ...
  return (
    <main>
      <section className="relative h-[40vh] min-h-[300px] flex items-center justify-center">
        <Image src="https://images.unsplash.com/photo-1517433670267-08bbd4be890f?w=1920&q=80" alt="A variety of fresh sourdough breads and baked pastries on display shelves" fill priority className="object-cover" />
