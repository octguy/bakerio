...
const prev = () => {
  ...
  return (
    <div className="group relative h-full min-h-[200px] overflow-hidden rounded-[2rem] border border-espresso/10 bg-espresso text-cream shadow-[0_30px_70px_-45px rgba(44,24,16,0.85)] transition-[opacity,transform,background-color] duration-[600ms] ease-[cubic-bezier(0.2,0,0,1)] lg:rounded-[2.75rem]">
...
<div
      ...
      {extendedSlides.map((slide, i) => (
        <div key={i} className="min-w-full relative h-full min-h-full flex-1">
          ...
          <div className="absolute inset-x-5 bottom-5 sm:inset-x-7 sm:bottom-7 lg:bottom-8">
            <h1 className="max-w-[11ch] font-display text-[clamp(3rem,16vw,6.6rem)] leading-[0.76] tracking-[-0.08em] text-cream [text-shadow:0_16px_30px_rgba(0,0,0,0.28)] lg:text-[clamp(3.4rem,5.5vw,6.4rem)] min-[1440px]:text-[clamp(3.75rem,4.8vw,5.9rem)] 2xl:text-[clamp(4.25rem,6vw,7.5rem)]">
              {slide.title}
    ...
    <button
      ...
      className="absolute left-4 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-espresso/60 text-cream shadow-md transition-[opacity,transform,background-color] duration-300 hover:scale-110 hover:bg-espresso/80 active:scale-95 can-hover:opacity-0 can-hover:group-hover:opacity-100 focus-visible:opacity-100"
    >
      <ChevronLeft size={24} />
    </button>
    <button
      ...
      className="absolute right-4 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-espresso/60 text-cream shadow-md transition-[opacity,transform,background-color] duration-300 hover:scale-110 hover:bg-espresso/80 active:scale-95 can-hover:opacity-0 can-hover:group-hover:opacity-100 focus-visible:opacity-100"
    >
