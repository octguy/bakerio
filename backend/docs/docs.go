    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/BranchProductDetailListResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
            ...
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/MarkReadAllResponse"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/BranchStatsResponse"
                        }
                    }
                }
            }
        },
        "/statistics/branches/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Periods are today / this_week / this_month / all_time in\nAsia/Ho_Chi_Minh. super_admin can target any branch; a\nbranch_manager only their own.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/BranchDetailStats"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/ProductStatsResponse"
                        }
                    }
                }
            }
        },
        "/statistics/products/{id}/timeseries": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Same calendar buckets as /statistics/timeseries but\naggregated over orders.order_items filtered by product_id.\nScope: super_admin + product_manager may target any branch\nvia ?branch_id= (omit for all branches); branch_manager is\nforced to own branch.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "RFC3339 datetime. Default: 30 days back (day), 12 weeks back (week), 12 months back (month), 5 years back (year).",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "RFC3339 datetime. Default: now.",
                        "name": "to",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Branch UUID. Admin + product_manager may target any branch; omit for all branches. Ignored for branch_manager (forced to own branch).",
                        "name": "branch_id",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/ProductTimeseriesResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
        ...
        "/statistics/timeseries": {
            "get": {
                ...
                "description": "Returns one point per calendar-aligned bucket in\nAsia/Ho_Chi_Minh. Empty buckets are zero-filled. Granularity\nwhitelist: day / week / month / year.\nDefaults when from/to omitted: last 30 d (day), 12 w (week),\n12 mo (month), 5 y (year).\nScope: super_admin may target any branch via ?branch_id= or\nomit for all branches; branch_manager is forced to own branch.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Branch UUID (admin only — ignored for branch_manager, who is forced to own branch)",
                        "name": "branch_id",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "BranchDetailStats": {
            ...
            "properties": {
                ...
                "top_products": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/BranchTopProduct"
                    }
                },
                "unique_customers": {
                    "type": "integer"
        ...
        "ProductTimeseriesResponse": {
            ...
            "properties": {
                ...
                "points": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ProductTimeseriesPoint"
                    }
                },
                "product_id": {
                    "type": "string"
        ...
        "SeedDemoSummary": {
            ...
            "properties": {
                ...
                "memberships": {
                    "description": "membership rows derived from seeded orders",
                    "type": "integer"
                },
                "orders": {
